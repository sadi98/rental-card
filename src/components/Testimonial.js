    ...
    return(
        <div className='mt-5'>
            <Container fluid="md">
                ...
                <Carousel id="carouselExampleControlsNoTouching"  activeIndex={index}
                    ...
                    <Carousel.Item>
                        <Card>
                            <Card.Body>
                            <Row>
                                <Col lg={2} className='text-center mb-2 mb-lg-0'>
                                    <img
                                ...
                                <Col lg={10}>
                                    <div className="ms-3 d-flex flex-column justify-content-center align-items-center align-items-lg-start">
                                    <div className="stars">
                                    ...
                                    <span className="text-muted mt-3 text-center text-lg-start">Sadi Nur Sholeihin 25, Jakarta</span>
                                    </div>
                                </Col>
                            </Row>
                            </Card.Body>
                        ...
                        <Card>
                            ...
                            <Row>
                                ...
                                <Col lg={10}>
                                    ...
                                    <span className="text-muted mt-3 text-center text-lg-start">John Dee 32, Bromo</span>
                                    </div>
                                </Col>
                            </Row>
                            </Card.Body>
                        ...
                        <Card>
                            ...
                            <Row>
                                ...
                                <Col lg={10}>
                                    ...
                                    <span className="text-muted mt-3 text-center text-lg-start">Ita Purnamasari 24, Padang</span>
                                    </div>
                                </Col>
                            </Row>
                            </Card.Body>
